...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kunut\OneDrive\Desktop\New folder (3)\ML-MODEL-DEPLOYMENT-USING-FLASK\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kunut\OneDrive\Desktop\New folder (3)\ML-MODEL-DEPLOYMENT-USING-FLASK\env\Scripts\deactivate.nu'
